...
public class Result_manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sour = PlayerPrefs.GetInt("st1runk");
    ...
    void Update()
    {
        ...
        if (Result_num.Rtime <= 600 && Result_num.Rsec == 3 && Result_num.Rdss == 0 && Result_num.Rrc >= 250)
        {
            TotalText.text = "S";
            if (sour < 4)
            {
                PlayerPrefs.SetInt("st1runk", 4);
            }
        }
